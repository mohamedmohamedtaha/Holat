...
import com.holat.holat.databinding.FragmentSendEscalationBinding
...
@AndroidEntryPoint
class SendEscalationFragment : BaseBottomSheetDialogFragment() {
    private lateinit var binding: FragmentSendEscalationBinding
    ...
    override fun getBinding(): ViewBinding {
        binding = FragmentSendEscalationBinding.inflate(layoutInflater)
        return binding
    }

...
fun Activity.drawLabel(name: String): TextView {
    val initializeTextView = initializeTextView()
    initializeTextView.textSize = 17f
    initializeTextView.setTypeface(null, Typeface.BOLD)
...
@SuppressLint("SetTextI18n")
fun Activity.drawLabel(globalView: GlobalView): TextView {
    val initializeTextView = initializeTextView()
    initializeTextView.textSize = 17f
    initializeTextView.setTypeface(null, Typeface.BOLD)
    initializeTextView.visibility = View.VISIBLE
